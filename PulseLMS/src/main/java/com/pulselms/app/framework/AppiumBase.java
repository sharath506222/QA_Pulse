...
public class AppiumBase extends WebDriverBase {
	...
	public void setDriver(AppiumDriver<?> appdriver){
...
/*	public void unlockScreen()  {
	...
	public void rotateDeviceToPortrait(){
		...
		log.info("Rotated screen to PORTRAIT");
	}
	...
	//	WebElement elem = wait(Until.elementToBeClickable(elementlocator));
		WebElement elem = this.driver.findElement(ObjectLocators.getBySelector(elementlocator));
		this.driver.tap(1, elem, duration);
		log.info("tapped at element: " + elementlocator);
	}
	
	protected void tapElement(WebElement element,int duration){
		this.driver.tap(1, element, duration);
		log.info("tapped at element: " + element);
	}
